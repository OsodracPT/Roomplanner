...
@Component({
  selector: 'app-pav-d-firstfloor',
  templateUrl: './pav-d-firstfloor.component.html',
  styleUrls: ['./pav-d-firstfloor.component.css']
})
export class PavDFirstfloorComponent implements OnInit {
