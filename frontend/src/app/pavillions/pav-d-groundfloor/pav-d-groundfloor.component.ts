...
@Component({
  selector: 'app-pav-d-groundfloor',
  templateUrl: './pav-d-groundfloor.component.html',
  styleUrls: ['./pav-d-groundfloor.component.css']
})
export class PavDGroundfloorComponent implements OnInit {
  @Input() rooms: Room[];
